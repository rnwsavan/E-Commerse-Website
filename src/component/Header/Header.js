                        ...
                        <nav className="main-menu">
                            <ul className="flex flex-wrap">
                                ...
                                <li className="main-menu__item relative group">
                                    ...
                                    <NavLink exact className="block py-10 xl:px-6 md:px-5 capitalize font-normal text-md text-primary hover:text-orange transition-all" to={"/about"}>About-Us</NavLink>
                                </li>
                                <li className="main-menu__item">
                                    ...
                                    <li className="main-menu__item"><NavLink exact className="block py-10 xl:px-6 md:px-5 capitalize font-normal text-md text-primary hover:text-orange transition-all" to={"/product"}>Products</NavLink></li>
                            </ul>
                        </nav>
                    </div>
